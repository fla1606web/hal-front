                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              child: SvgPicture.asset(
                                'assets/vectors/gallery_2_x2.svg',
                              ),
                            ),
                          ),
                        ),
                ...
                child: Row(
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Container(
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    margin: EdgeInsets.fromLTRB(1, 85, 1, 30),
                                    child: Text(
                                    ...
                                    child: ElevatedButton(
                                                    onPressed: () { 
                                                      ...
                                                      result.then((value) {
                                                          ...
                                                          action: SnackBarAction(label: "Thanks!" ,
                                                          onPressed: () {},
                                                            ),
                                                          );
                    ...
                    Visibility(
                      visible: setVisible,
                      child: Container(
                        margin: EdgeInsets.fromLTRB(100, 238, 0, 0),
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                              ...
                              child: Opacity(
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    height: 70,
                                    child: SvgPicture.asset(
                                      'assets/vectors/gallery_4_x2.svg',
                                    ),
                                  ),
                                ),
                              ),
