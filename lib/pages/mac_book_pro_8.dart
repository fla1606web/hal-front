...
class MacBookPro8 extends StatefulWidget {
  @override
  State<MacBookPro8> createState() => _MacBookPro8State();
}

class _MacBookPro8State extends State<MacBookPro8> {
  dynamic _id;
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(0, 0, 93, 10),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    text: 'Al crear una cuenta, aceptas los',
                                    style: GoogleFonts.getFont(
                                      'Fredoka',
                                      fontWeight: FontWeight.w500,
                                      fontSize: 13,
                              ...
                              Row(
                                ...
                                children: [
                                    ...
                                    TextButton.icon(
                                      ...
                                      label: const Text('Creála desde aquí'),
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                margin: EdgeInsets.fromLTRB(36, 0, 0, 70),
                                child: Opacity(
                                  opacity: 0.3,
                                  child: Container(
                                    width: 70,
